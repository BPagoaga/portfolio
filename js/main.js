	  ...
	  function processJson() {
	    if (req.readyState == 4) {
	      ...
	      doc_arr.map(function (arr) {
	        ...
	        ul.append($('<div class="row">').append(h4[section].text(section)));
	  ...
	  function parsingArr(obj, i, arr) {
	    ...
	    if (Object.keys(obj).length > 0) {
	      ...
	      var li = $('<li class="col-xs-12 col-sm-6 col-md-3">'),
	          img = $('<figure><img class="img-portfolio img-responsive img-thumbnail" src="' + obj.thumbnail + '"></figure>'),
	      ...
	      var value = void 0;
	      for (value in h4) {
	        h4[value].after(li.append(portfolioItem.append(a.append(img.append(figcaption), p))));
	      }
	    }
	  }
	})();
